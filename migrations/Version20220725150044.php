 ...
 */
final class Version20220725150044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sessions (id INT AUTO_INCREMENT NOT NULL, responsable_id INT DEFAULT NULL, heure_debut DATETIME DEFAULT NULL, heure_fin DATETIME DEFAULT NULL, promotion VARCHAR(255) DEFAULT NULL, date_debut_promo DATETIME NOT NULL, date_fin_promo DATETIME NOT NULL, ville VARCHAR(255) DEFAULT NULL, state SMALLINT NOT NULL, code_session VARCHAR(8) NOT NULL, INDEX IDX_9A609D1353C59D72 (responsable_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
