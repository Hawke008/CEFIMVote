 ...
 */
class ResponsablesRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function add(Responsables $entity, bool $flush = false): void
    {
    ...
    public function remove(Responsables $entity, bool $flush = false): void
    {
    ...
    {
        if (!$user instanceof Responsables) {
