...
class Responsables implements UserInterface, PasswordAuthenticatedUserInterface
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'responsable', targetEntity: Sessions::class)]
    private $sessions;
    ...
    public function removeSession(Sessions $session): self
    {
        if ($this->sessions->removeElement($session)) {
            ...
            if ($session->getResponsable() === $this) {
